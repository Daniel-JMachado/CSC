...
login_module = import_py_file("login", os.path.join(base_dir, "app", "pages", "login.py"))
morador_module = import_py_file("morador", os.path.join(base_dir, "app", "pages", "morador.py"))
catador_module = import_py_file("catador", os.path.join(base_dir, "app", "pages", "catador.py"))
admin_module = import_py_file("admin", os.path.join(base_dir, "app", "pages", "admin.py"))
auth_module = import_py_file("auth", os.path.join(base_dir, "app", "utils", "auth.py"))
...
def load_css():
    try:
        with open(os.path.join(base_dir, "app", "css", "style.css"), encoding="utf-8") as f:
